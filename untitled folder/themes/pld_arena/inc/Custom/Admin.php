...
use Plda\Api\Settings;
use Plda\Api\Callbacks\SettingsCallback;
...
class Admin
{
	...
	public function register()
	{
		...
		//$this->enqueue()->register_settings();
	...
	private function pages()
	{
		$admin_pages = array(
			array(
				'page_title' => 'PLDA Admin Page',
				'menu_title' => 'PLDA',
				'capability' => 'manage_options',
				'menu_slug' => 'plda',
				'callback' => array( $this->callback, 'admin_index' ),
				'icon_url' => get_template_directory_uri() . '/assets/images/admin-icon.png',
				'position' => 110,
			)
		);
		...
		$admin_subpages = array(
			array(
				'parent_slug' => 'plda',
				'page_title' => 'Plda Options',
				'menu_title' => 'OPTIONS',
				'capability' => 'manage_options',
				'menu_slug' => 'plda_options',
